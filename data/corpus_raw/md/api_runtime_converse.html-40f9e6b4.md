# Converse - Amazon Bedrock Converse - Amazon Bedrock
...
For information about the Converse API, see Use the Converse API .
...
Content-type: application/json { " additionalModelRequestFields ": JSON value ,
...
Additional inference parameters that the model supports, beyond the
 base set of inference parameters that Converse and ConverseStream support in the inferenceConfig field. For more information, see Model parameters . 
...
Additional model parameters field paths to return in the
 response. Converse and ConverseStream return the requested fields as a JSON Pointer object in the additionalModelResponseFields field. The following is example JSON for additionalModelResponseFieldPaths . 
...
Required: No 
inferenceConfig 
Inference parameters to pass to the model. Converse and ConverseStream support a base
...
Response Syntax 
HTTP/1.1 200
Content-type: application/json { " additionalModelResponseFields ": JSON value ,
 ...
 " stopReason ": " string ",
 " trace ": { " guardrail ": { " actionReason ": " string ",
 " inputAssessment ": { " string " : { " appliedGuardrailDetails ": { " guardrailArn ": " string ",
 " guardrailId ": " string ",
 ...
 " modelOutput ": [ " string " ],
 " outputAssessments ": { " string " : [ { " appliedGuardrailDetails ": { " guardrailArn ": " string ",
 " guardrailId ": " string ",
 " guardrailOrigin ": [ " string " ],
 " guardrailOwnership ": " string ",
 " guardrailVersion ": " string "
 ...
 " usage ": { " cacheDetails ": [ { " inputTokens ": number ,
 " ttl ": " string "
 }
 ],
...
Content-type: application/json { "messages": [ { "role": "user",
...
Sample Request 
HTTP/1.1 200
Content-type: application/json { "output": { "message": { "content": [ { "text": "<text generated by the model>"
 }
 ],
 "role": "assistant"
 }
...
POST /model/anthropic.claude-3-sonnet-20240229-v1:0/converse HTTP/1.1
Content-type: application/json { "messages": [ { "role": "user",
 "content": [ { "text": "Provide general steps to debug a BSOD on a Windows laptop."
 }
 ]
 }
 ],
...
Sample Request 
POST /model/us.anthropic.claude-3-5-sonnet-20240620-v1:0/converse HTTP/1.1 { "messages": [ { "role": "user",
...
Content-type: application/json { "promptVariables": { "genre": { "text": "pop"
 }
 }
} 
See Also 
